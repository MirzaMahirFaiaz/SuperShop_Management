...
public class Edit_Supplier extends javax.swing.JFrame {
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        if (jTableViewSupplier.getSelectedRowCount() != 0) {
            ...
            username = (String) model.getValueAt(jTableViewSupplier.getSelectedRow(), 0);
            String pass = (String) model.getValueAt(jTableViewSupplier.getSelectedRow(), 1);
            String ut = (String) model.getValueAt(jTableViewSupplier.getSelectedRow(), 2);
            ut = ut.toLowerCase();

            jTextFieldSupplierName.setText(username);
            jTextFieldPhone.setText(pass);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        try {
            ...
            String un = jTextFieldSupplierName.getText();
            String pass = jTextFieldPhone.getText();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if (jTableViewSupplier.getSelectedRowCount() == 1) {
            ...
            try {
                ...
                String un = (String) model.getValueAt(jTableViewSupplier.getSelectedRow(), 0);
